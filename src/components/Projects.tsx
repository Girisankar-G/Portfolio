  ...
  const projects: Project[] = [
    {
      ...
      title: "Perscripto",
      description:
        "A Doctor Appointment System built using the MERN stack (MongoDB, Express, React, Node.js) that allows patients to book appointments and doctors to manage schedules.",
      image:
        "https://images.pexels.com/photos/5905700/pexels-photo-5905700.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
    ...
    },
    {
      ...
      title: "Netflix Clone",
      description:
        "A responsive front-end Netflix clone built using HTML, CSS, and JavaScript. It mimics the original UI with features like movie thumbnails and hover effects.",
      image:
    ...
    },
    {
      ...
      description:
        "A machine learning model developed to analyze sentiment from tweets using natural language processing techniques. It classifies tweets into positive, negative, or neutral.",
      image:
        "https://images.pexels.com/photos/4597041/pexels-photo-4597041.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
      tags: ["python", "ml", "nlp"],
    ...
    },
    {
      ...
      description:
        "A project combining a front-end built with HTML/CSS and a machine learning model in Python to filter and classify resumes based on job requirements.",
      image:
        "https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260",
